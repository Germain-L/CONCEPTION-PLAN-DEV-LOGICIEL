...
/**
 * 
 * @param id Identifiant de la réservation modifiée
 ...
 */
data class BookingsIdPut200Response(

    @Schema(example = "null", description = "Identifiant de la réservation modifiée")
